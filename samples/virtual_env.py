...
class VirtualEnviroment(BasicEnviroment):
    def __init__(self, type, name, state_dim, state_count, action_dim, action_count):
        ...
        self.obs_space_info = self.parseEnvSpace((name, state_dim, state_count))
        self.action_space_info = self.parseEnvSpace((name, action_dim, action_count))
        self.reset()
    ...
    def step(self, action):
        ...
        self.info = info
        self.obs = next_obs
        return obs, reward, next_obs, done, info
